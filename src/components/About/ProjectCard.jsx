  ...
  return (
    <div className="projectCard cursor-pointer h-[45vh] flex flex-col items-start">
      ...
      <div className="mt-3 flex items-center justify-between px-2 w-full">
        ...
        <div>
          <a href={val.projectUrl} target="_blank" rel="noopener noreferrer">
            <Button variant='outline' className={`text-black bg-transparent border-black ${val.status === 'In Progress' ? 'bg-black text-white' : ''}` }>
